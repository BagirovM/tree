    ...
    <div className='back'>   
        ...
        <div className='who'>
            ...
            <div>
             ...
             <div> <img src={image1} className="Men-first"></img>
             ...
             <div> <img src={image2} className="Men-first"></img>
              <h4 className='o'><span className='hey'>Hi my name is Mike</span> The company GLX TRVLis simply gorgeous. I really liked the service very much, I just advise everyone. If there is an opportunity, I will come to them again. Helped to choose a tour into space.I did not regret that I turned to them</h4></div>
              ...
              <h4 className='o a'><span className='hey'>Hi my name is Sam</span> The company GLX TRVLis simply gorgeous. I really liked the service very much, I just advise everyone. If there is an opportunity, I will come to them again. Helped to choose a tour into space.I did not regret that I turned to them</h4>
